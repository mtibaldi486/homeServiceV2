...
CREATE TABLE IF NOT EXISTS `db_paris`.`prestation` (
  ...
  PRIMARY KEY (`id_prestation`, `ville`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_paris`.`reservation` (
  ...
  CONSTRAINT `fk_reservation_prestation1`
    FOREIGN KEY (`prestation_id_prestation` , `prestation_ville`)
    REFERENCES `db_paris`.`prestation` (`id_prestation` , `ville`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_paris`.`facturation` (
  ...
  CONSTRAINT `fk_facturation_prestataire1`
    FOREIGN KEY (`prestataire_id_prestataire` , `prestataire_ville`)
    REFERENCES `db_paris`.`prestataire` (`id_prestataire` , `ville`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_paris`.`prestation_has_prestataire`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_paris`.`prestation_has_prestataire` (
  `prestation_id_prestation` INT NOT NULL,
  `prestation_ville` VARCHAR(45) NOT NULL,
  `prestataire_id_prestataire` INT NOT NULL,
  `prestataire_ville` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`prestation_id_prestation`, `prestation_ville`, `prestataire_id_prestataire`, `prestataire_ville`),
  INDEX `fk_prestation_has_prestataire_prestataire1_idx` (`prestataire_id_prestataire` ASC, `prestataire_ville` ASC) VISIBLE,
  INDEX `fk_prestation_has_prestataire_prestation1_idx` (`prestation_id_prestation` ASC, `prestation_ville` ASC) VISIBLE,
  CONSTRAINT `fk_prestation_has_prestataire_prestation1`
    FOREIGN KEY (`prestation_id_prestation` , `prestation_ville`)
    REFERENCES `db_paris`.`prestation` (`id_prestation` , `ville`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_prestation_has_prestataire_prestataire1`
    FOREIGN KEY (`prestataire_id_prestataire` , `prestataire_ville`)
    REFERENCES `db_paris`.`prestataire` (`id_prestataire` , `ville`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
